...
export default function PendingPage() {
  ...
  const loadBills = async () => {
    ...
    try {
      ...
      if (salesRes.ok) {
        ...
        // Filter for pending only (no advance)
  ...
  const salesTotal = filteredSalesBills.reduce((sum, bill) => sum + bill.totalAmount, 0);
  const rentalTotal = filteredRentalBills.reduce((sum, bill) => sum + bill.totalAmount, 0);
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">Sales Pending</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">Rental Pending</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">₹{rentalTotal.toFixed(2)}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-destructive">₹{grandTotal.toFixed(2)}</div>
            <p className="text-sm text-muted-foreground">{filteredSalesBills.length + filteredRentalBills.length} bills</p>
          </CardContent>
        </Card>
      </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="font-semibold text-destructive">₹{editDialog.bill.totalAmount.toFixed(2)}</div>
                </div>
              </div>
